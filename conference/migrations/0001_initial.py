    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_room', models.CharField(blank=True, max_length=1000000)),
                ('waiting_room', models.BooleanField(default=True, verbose_name='waiting_room')),
                ('organizer', models.BooleanField(default=True, verbose_name='organizer')),
                ('participant', models.BooleanField(default=True, verbose_name='participant')),
                ('entrance_organizer', models.BooleanField(default=True, verbose_name='entrance_organizer')),
                ('entrance_participant', models.BooleanField(default=True, verbose_name='entrance_participant')),
